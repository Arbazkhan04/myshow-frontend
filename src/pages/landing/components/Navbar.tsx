      ...
      <div className="mx-auto max-w-7xl px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden items-center gap-8 md:flex">
            {["Features", "Pricing", "Community", "Documentation"].map(
              (item, index) => (
                <motion.a
                  key={index}
                  href="#"
        ...
        >
          <div className="flex flex-col gap-4 pt-4">
            ...
            <div className="flex flex-col gap-2 border-t border-[oklch(0.9_0_0)] pt-4">
              <a
                href="#"
                className="text-center text-[oklch(0.45_0_0)] transition-colors hover:text-[oklch(0.58_0.26_300)]"
              >
                Sign In
              </a>
              <a
                href="#"
                className="rounded-full bg-gradient-to-r from-[oklch(0.58_0.26_300)] to-[oklch(0.74_0.25_340)] px-6 py-2 text-center text-white"
              >
                Get Started
              </a>
            </div>
