...
export interface paths {
    ...
    "/api/v1/character/default": {
         ...
         * @description Fetches all characters marked as default (isDefault: true). This is a public endpoint accessible to all users.
         */
        get: operations["CharacterController_getDefaultCharacters"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/character/update/{id}": {
         ...
         * @description Updates any field of a character by its unique ID. All fields are optional, only provided fields will be updated.
         */
...
export interface components {
    schemas: {
        ...
        CreateCharacterDto: {
            ...
            is_sample?: boolean;
            is_template?: boolean;
            /** @description If true, character will be shown to all users as a default character */
            isDefault?: boolean;
        ...
        UpdateCharacterDto: Record<string, never>;
...
export interface operations {
    ...
    CharacterController_getDefaultCharacters: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody?: never;
        responses: {
            /** @description Default characters fetched successfully */
            200: {
                headers: {
                    [name: string]: unknown;
                };
        ...
        requestBody: {
            content: {
                "application/json": {
                    ...
                    story: string;
                    character: {
                        /** @example 694407f2d1461f1b2ff2edcc */
                        _id?: string;
